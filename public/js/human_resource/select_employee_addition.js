    ...
    let inner = `
        ...
        <td>
            <div class="input-group">
                <input data-id="${addition_count}" id="a_employee_${addition_count}" class="a_employee" name='employee[]'>
                <input type="hidden" name="employee_id[]" value="">
            </div>
        </td>
        <td>
            <input type="text" placeholder="0.00" data-id="${addition_count}" id="a_price_${addition_count}" class="form-control" name="price[]" required>
        </td>
        <td>
