...
<div class="card col-xl-10 mb-3">
    <div class="card-body">
        <h1 class="mb-3">New Proforma</h1>
        <form id="form-new-proforma" method="post" enctype="multipart/form-data">
    ...
    <div class="card-footer bg-white">
        <button type="button" class="btn btn-primary">Save Proforma</button>
