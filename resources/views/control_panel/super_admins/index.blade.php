...
@if (Auth::user()->is_control_panel_access_accepted)
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="alert alert-danger" role="alert">
                    <div class="container">
                        <div class="row">
                            <h4 class="alert-heading">You are invited to become a super admin.</h4>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <p> To accept, please enter your password.<br>
                                To decline, simply click the 'Decline' link</p>
                        </div>
                    </div>

                    <div class="container">
                        <form id="accept-invitation" action="{{ url('/control/accept') }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    @if(\Session::has('error'))
                                        <p class="text-danger error-message error-message-password">{{ \Session::get('error') }}</p>
                                    @endif
                                </div>
                            </div>
                        </form>
                        <form id="reject-invitation" action="{{ url('/control/reject') }}" method="POST">
                            @csrf
                            <div class="row">
                                <button type="submit" class="btn btn-primary" form="accept-invitation">Accept Invitation</button>
                                <button type="submit" class='ml-auto mt-2 btn btn-link' form="reject-invitation">Decline Invitation</a>
                            </div>
                        </form>
                    </div>
