                        ...
                        <div class="d-flex justify-content-between mb-3">
                            <div>
                                ...
                                <label class="form-check-label">
                                    IF (Taxable income>Income) : (Taxable income*Rate)-Deduction 
                                </label>
                            </div>
                            <div>
                                ...
                                <table class="table">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-between">
                                                    ...
                                                    <input type="number" id="working_days" class="form-control w-25"
                                                        name="working_days" placeholder="Working days" required> /
                                                    <input type="number" id="working_hours" class="form-control w-25"
                                        ...
                                        <tr>
                                            ...
                                            <td> <input type="number" id="day_rate" class="form-control" name="day_rate"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="number" id="night_rate" class="form-control"
                                                    name="night_rate" required placeholder="0.00">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="number" id="holiday_weekend_rate" class="form-control"
