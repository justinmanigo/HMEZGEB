            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('customers.receipt') }}">Receipt</a>
                        <a class="collapse-item" href="{{ route('customers.customer') }}">Customer</a>
                        <a class="collapse-item" href="{{ route('customers.deposit') }}">Deposit</a>
                    </div>
                </div>
            </li>
