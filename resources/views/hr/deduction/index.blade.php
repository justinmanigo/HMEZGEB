    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-9 col-lg-4">
                        <input type="date" class="form-control" id="d_date" name="date" placeholder="" required>
                    </div>
                </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" form="modal-deduction">Save Deduction</button>
            </div>
        </div>
    </div>
</div>
