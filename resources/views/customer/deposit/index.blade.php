            ...
            <div class="modal-body">
                <form id="form-deposit" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <label for="d_deposit_id" class="col-sm-3 col-lg-2 col-form-label">Deposit Ticket ID<span class="text-danger ml-1">*</span></label>
                        <div class="col-sm-9 col-lg-4">
                            <input type="text" class="form-control" id="d_deposit_ticket_id" name="deposit_ticket_id">
                        </div>
                    </div>
                    <hr>
