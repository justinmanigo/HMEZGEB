<form class="ajax-submit-updated" action="{{route('receipts.credit_receipts.store')}} "id="form-credit-receipt" method="post" enctype="multipart/form-data" data-message="Successfully added credit receipt." data-noreload="true" data-onsuccess="credit_receipt_search" data-onsuccessparam="credit_receipts_page_number_current" data-modal="modal-credit-receipt">
    @csrf
        ...
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" form="form-credit-receipt">Save & Close</button>
                    <button type="submit" class="btn btn-primary" form="form-credit-receipt" data-new="modal-credit-receipt">Save & New</button>
                </div>
            </div>
        </div>
    </div>
