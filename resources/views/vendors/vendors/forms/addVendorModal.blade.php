...
<div class="modal-body h6">				
    ...
    <div class="form-group row">
        <label for="tin_number" class="col-md-4 col-lg-2 col-form-label">TIN number:<span class="text-danger ml-1">**</span></label>
    ...
    <div class="row form-group">
        <label for="contact_person" class="col-md-4 col-lg-2 col-form-label">Contact Person:</label>
