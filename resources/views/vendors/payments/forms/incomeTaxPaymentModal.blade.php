<div class="modal-body h6">				
    <div class="row form-group">	
            ...
            <div class="col-12 col-lg-6">
                ...
                <div class="form-group row">
                    <label for="it_payment_reference" class="col-4 col-form-label text-lg-right">Payment Reference:</label>
                    <div class="col-8">
                        <input type="date" class="form-control" id="it_payment_reference" name="payment_reference" placeholder="" value="" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="it_cheque_number" class="col-4 col-form-label text-lg-right">Cheque #:<span class="text-danger ml-1">*</span> :</label>
                    <div class="col-8">
                        <input type="text" class="form-control" id="it_cheque_number" name="cheque_number" placeholder="" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="it_bill_number" class="col-4 col-form-label text-lg-right">Account:</label>
                    <div class="col-8">
                        <input type="text" class="form-control" id="it_bill_number" name="account" placeholder="">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="it_bill_number" class="col-4 col-form-label text-lg-right">Accounting Period:</label>
                    <div class="col-8">
                        <input type="text" class="form-control" id="it_bill_number" name="period" placeholder="">
                    </div>
                </div>
            </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-lg-10 col-md-8 ">
            <input type="text" class="form-control" id="it_amount" name="amount" placeholder="">
        </div>
    </div>
    <div class="form-group row">
        <label for="amount_word" class="col-lg-2 col-md-4 col-form-label ">Amount in Word<span class="text-danger ml-1">*</span> :</label>
        <div class="col-lg-10 col-md-8 ">
            <input type="text" class="form-control" id="it_amount_word" name="amount_word" placeholder="">
        </div>
    </div>
