<div class="modal-body h6">				
    <div class="row form-group">	
            ...
            <div class="col-12 col-lg-6">
                ...
                <div class="form-group row">
                    <label for="p_payment_reference" class="col-4 col-form-label text-lg-right">Payment Reference:</label>
                    <div class="col-8">
                        <input type="date" class="form-control" id="p_payment_reference" name="payment_reference" placeholder="" value="" required>
                    </div>
                </div>
                <div class="form-group row">
